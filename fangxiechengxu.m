...
load('formatdata.mat');
training_feats=datatrain(:,1:10:end);H_train=htrain(:,1:10:end);
testing_feats=datatest(:,1:10:end); H_test=htest(:,1:10:end);
% for i=1:10, nnz(htrain(i,:)),end     
clear('datatrain','htrain','datatest','htest');
